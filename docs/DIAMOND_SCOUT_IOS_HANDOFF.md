...
Signed EAS build `0.2.0 (18)` is recorded at `https://expo.dev/accounts/chrisbaso/projects/dugoutcall/builds/0e46e166-ea9d-4e41-8e5a-407298eb2c98`. Submission `1f28245a-bfd2-4cb5-934d-c8ad139aea8b` succeeded after the Apple agreements became active; App Store Connect processed the build and assigned it to the Coaches, Internal, and Team (Expo) internal groups with controlled-pilot notes. Complete `docs/FIELD_TEST.md` on two physical iPhones with AirPods before enabling pilot staffs.
